...
if [[ $# -ne 3 ]] ; then
    echo "Error: Must supply <objective {walker,branin2D,hart6D,micha10D}> <acquisition {EI,EIC,EIC_standard}> <exp_nr>"
else
	...
	echo "Copying data ..."
	scp -r amarcovalle@login.cluster.is.localnet:$root_remote/$1/$2_results/.hydra/* $root_local/$1/$2_results/cluster_data/.hydra/*
fi
